...
arregloEstudiantes.forEach((elemento) => {
    ...
    if (typeof elemento === 'object' && elemento !== null && 'nombre' in elemento) {
        (0, mostrarEstudiante_1.default)(elemento); // Si es un estudiante, mostrar su información
    }
});
...
(0, mostrarEstudiante_1.default)(e1); // Mostrar información del estudiante e1
(0, mostrarEstudiante_1.default)(e2); // Mostrar información del estudiante e2
